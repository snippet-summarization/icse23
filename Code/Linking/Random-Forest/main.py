...
from preprocessing.generate_xml import Preprocessing
from preprocessing.generate_comment import PreprocessingComment
...
# dataset folder
input_folder="/Users/matteo.ciniselli/Desktop/baseline_antonio/baseline_antonio/replication/input"
# xml where you want to save the xml processed by SrcML
xml_folder="/Users/matteo.ciniselli/Desktop/baseline_antonio/baseline_antonio/replication/xml"
# output folder where we save the skipgram model and the feature vectors
output_folder="/Users/matteo.ciniselli/Desktop/baseline_antonio/baseline_antonio/replication"
...
class Wrapper():
    ...
    def write_all_features(self):
        ...
        for s in sets:
            ...
            self.write_csv(header_full, feature_full, "{}_features.csv".format(s))

            self.write_is_commented(feature_full, is_commented, "{}_results.csv".format(s))
    ...
    def preprocess_input(self):
        p1=Preprocessing(xml_folder, output_folder, input_folder)
        p1.store_xml()
        p2=PreprocessingComment(xml_folder, output_folder, input_folder)
        p2.store_comment_info()

def main():
    parser = argparse.ArgumentParser()

    parser.add_argument("-preprocessing", "--preprocessing", action="store_true",
                        help="preprocess the input files to generate xml and comments")
    ...
    if args.preprocessing:
        # step 0: preprocess the input files to get the xml and the comment info
        w.preprocess_input()
